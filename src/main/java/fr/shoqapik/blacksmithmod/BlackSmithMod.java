...
public class BlackSmithMod {
    ...
    public BlackSmithMod() {
        ...
        INSTANCE.registerMessage(0, BlackSmithShowDialogPacket.class, BlackSmithShowDialogPacket::encode, BlackSmithShowDialogPacket::decode, BlackSmithShowDialogPacket::handle);
