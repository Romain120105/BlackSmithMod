package fr.shoqapik.blacksmithmod.menu.container;
...
public class SmithCraftContainer implements Container, StackedContentsCompatible {
    ...
    public SmithCraftContainer(AbstractContainerMenu p_39325_, int p_39326_, int p_39327_) {
